...
app.get("/llms.txt", (c) => c.text(`# Agent Search Pro\nStatus: Experimental beta\nVerified: free API/MCP access, canonical x402 challenges, durable telemetry, and controlled direct-transfer fulfillment\nSigned facilitator settlement: verified for operator-funded /api/search and /api/synthesis purchases\nSearch transaction: 0x05d41f696732284339130d869cdc84b0d259f5122b9d61212bcd083675952555\nSynthesis transaction: 0x67bae3bafd3e93ec671a2ec516b3ac3826603938d8518a18b97dc221e3eadc9a\nExternal paid demand: not validated\nFree sample: GET ${ORIGIN}/api/sample?q=x402\nPaid search: POST ${ORIGIN}/api/search ($0.02 USDC)\nPaid synthesis: POST ${ORIGIN}/api/synthesis ($0.10 USDC)\nOpenAPI: ${ORIGIN}/openapi.json\nMCP endpoint: ${ORIGIN}/mcp\nSupport: api@supersignal.tech\n`));
